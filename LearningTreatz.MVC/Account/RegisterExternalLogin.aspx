<%@ Page Language="C#" Title="Register an external login" MasterPageFile="~/Site.Master" AutoEventWireup="True" CodeBehind="RegisterExternalLogin.aspx.cs" Inherits="LearningTreatz.Account.RegisterExternalLogin" %>
